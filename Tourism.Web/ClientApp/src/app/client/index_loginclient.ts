...
export class LoginClient extends ClientBase {
    ...
    /**
     * 登录
     * @param body (optional) 登录模型
     * @return Success
     */
    login(body: ParamForLogin | null | undefined): Observable<LoginModelInfoModel> {
        let url_ = this.baseUrl + "/Index/Login/Login";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processLogin(response: HttpResponseBase): Observable<LoginModelInfoModel> {
